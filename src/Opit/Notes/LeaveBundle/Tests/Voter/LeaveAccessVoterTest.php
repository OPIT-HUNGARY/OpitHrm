...
namespace Opit\Notes\LeaveBundle\Tests\Voter;

use Symfony\Bundle\FrameworkBundle\Test\WebTestCase;
use Symfony\Component\Security\Core\Authentication\Token\UsernamePasswordToken;
use Opit\Notes\LeaveBundle\Security\Authorization\Voter\LeaveAccessVoter;
...
class LeaveAccessVoterTest extends WebTestCase
{
    ...
    {
        $generalManager = $this->em->getRepository('OpitNotesUserBundle:User')->findByUsername('generalManager');
        $admin = $this->em->getRepository('OpitNotesUserBundle:User')->findByUsername('admin');
        $user = $this->em->getRepository('OpitNotesUserBundle:User')->findByUsername('user');

        $leaveRequests = $this->em->getRepository('OpitNotesLeaveBundle:LeaveRequest')->findByEmployee($user);
