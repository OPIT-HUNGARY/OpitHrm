 ...
 * @subpackage Notes
 *
 * @ORM\Table(name="notes_tr_status_comments")
 * @ORM\Entity
 */
class CommentTRStatus extends AbstractComment
{
     ...
     * Set status
     *
     * @param \Opit\Notes\TravelBundle\Entity\StatesTravelRequests $status
     * @return CommentTRStatus
     */
    public function setStatus(\Opit\Notes\TravelBundle\Entity\StatesTravelRequests $status = null)
    {
        $this->status = $status;
