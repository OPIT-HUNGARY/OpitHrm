...
(function() {
  var $addCompanyTagLink, $addUserTagLink, $expensesPaidByMe, $expensesPaidByMeDesc, $expensesPaidByOpit, $expensesPaidByOpitDesc, $form, $formFieldset, $generalFormFields, $generalFormFieldset, $perDiem, addNewAdvanceReceived, addNewForm, allCurrencies, availableCurrencies, calculateAdvancesPayback, calculatePerDiem, convertCurrency, createCustomField, createDeleteButton, createDeleteExpenseButton, createTableRow, excludedCurrencies, expenseDateChange, reCreateAdvances, reCreateExpenses, setAvailableCurrencies, validateAllExpenseDates, validateExpenseDate;
  ...
  addNewAdvanceReceived = function(collectionHolder) {
    ...
    if (allCurrencies.length === 0) {
      $($('#travelExpense_teAdvancesReceived').data('prototype')).find('option').each(function() {
        return allCurrencies.push($(this).val());
      });
    }
