...
(function() {
  var $addCompanyTagLink, $addUserTagLink, $expensesPaidByMe, $expensesPaidByOpit, $form, $formFieldset, $generalFormFieldset, $perDiem, addNewForm, calculatePerDiem, createDeleteButton, createTableRow, reCreateExpenses;
