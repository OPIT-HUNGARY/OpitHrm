...
(function() {
  ...
  calculateAdvancesPayback = function() {
    var $break, $errorLabel, advancesRecieved, destinationCode, payback;
    ...
    $('.amount').each(function() {
      var amount, originCode, paidInAdvance;
      paidInAdvance = $(this).closest('.formFieldsetChild').find('.paid-in-advance').val();
      originCode = $(this).closest('.formFieldsetChild').find('.currency').val();
      if (paidInAdvance === '0') {
        amount = parseInt($(this).val());
        if (!isNaN(amount)) {
          return payback -= convertCurrency(originCode, destinationCode, amount);
        }
      }
    });
  ...
  $(document).ready(function() {
    var $advancesPayback, $advancesPaybackLabel, $advancesPaybackText, $advancesRecieved, $arrivalHour, $arrivalMinute, $buttonParent, $departureHour, $departureMinute, $perDiemAmountsTable, $secondFormFieldset, $td, $thirdFormFieldset, $toSettle, $toSettleLabel, $toSettleText, $tr, arrivalDate, arrivalDateVal, arrivalHourVal, arrivalMinuteVal, arrivalTime, companyPaidExpensesIndex, departureDate, departureDateVal, departureHourVal, departureMinuteVal, departureTime, userPaidExpensesIndex;
    ...
    $('.formFieldset').on('change', '.amount, .currency, .paid-in-advance', function() {
      return calculateAdvancesPayback();
    });
