...
(function() {
  var changeTravelStatus, deleteSingleRequest, order;
  ...
  $('#list-table').on('click', 'th .fa-sort', function() {
    var field;
  ...
  $('#list-table').on('click', '.fa-trash-o', function() {
