...
class LeaveRequest
{
   ...
   /**
     ...
     * Add leaves
     *
     * @param \Opit\Notes\HolidayBundle\Entity\Leave $leaves
     * @return LeaveRequest
     */
    public function addLeaf(\Opit\Notes\HolidayBundle\Entity\Leave $leaves)
    {
        $this->leaves[] = $leaves;
     ...
     * @param \Opit\Notes\HolidayBundle\Entity\Leave $leaves
     */
    public function removeLeaf(\Opit\Notes\HolidayBundle\Entity\Leave $leaves)
    {
