...
namespace Opit\Notes\NotificationBundle\Manager;
...
abstract class NotificationManager
{
    ...
    {
        $unreadNotifications = $this->entityManager->getRepository('OpitNotesNotificationBundle:Notification')
    ...
    public function getAllNotifications($currentUser)
    {
        ...
        $allNotifications = $this->entityManager
            ->getRepository('OpitNotesNotificationBundle:Notification')
        ...
        $lastNotifications = $this->entityManager->getRepository('OpitNotesNotificationBundle:Notification')
    ...
    {
        $status = $this->entityManager->getRepository('OpitNotesNotificationBundle:NotificationStatus')->find($statusId);
