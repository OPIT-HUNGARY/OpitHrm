...
(function() {
  var $addPerDiem, disableSaveButton, hoursCheck, validationOfGreaterThan0, validationOfHoursCompare, validationOfLessThan24,
  ...
  hoursCheck = function(hoursElement) {
    var $wrapper, errorMessage, hours, isLessThen24, isUnique;
    ...
    if (!isLessThen24) {
      ...
      return hours.each(function(index) {
        $wrapper = $(this).parent();
