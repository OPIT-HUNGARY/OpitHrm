...
class AdminUserControllerTest extends WebTestCase
{
    ...
    /**
     * @var \Opit\Notes\UserBundle\Entity\JobTitle
     */
    protected $jobTitle;
    
    /**
     * @var \Opit\Notes\UserBundle\Entity\Groups
     */
    protected $group;
    ...
    public function setUp()
    {
        ...
        $this->jobTitle = $this->em->getRepository('OpitNotesUserBundle:JobTitle')->findOneByTitle('CEO');
        $this->group = $this->em->getRepository('OpitNotesUserBundle:Groups')->findOneByRole('ROLE_FINANCE');
    }
