...
namespace Opit\Notes\UserBundle\Tests\Model;

use Opit\Notes\UserBundle\Model\UserService;
...
{
    /**
     * @var \Opit\Notes\UserBundle\Model\UserService 
     */
    ...
    public function setUp()
    {
        ...
        $mailer = $this->getMockBuilder('Opit\Notes\TravelBundle\Manager\EmailManager')
            ->disableOriginalConstructor()
            ->getMock();
    ...
    {
        // Mocking a User .
        $user = $this->getMockBuilder('Opit\Notes\UserBundle\Entity\User')
            ->disableOriginalConstructor()
            ->getMock();
        $user->expects($this->any())
            ->method('getEmail')
