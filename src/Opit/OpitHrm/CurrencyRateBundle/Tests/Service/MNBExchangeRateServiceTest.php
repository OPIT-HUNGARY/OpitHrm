...
use Opit\OpitHrm\CurrencyRateBundle\Service\MNBExchangeRateService;
...
{
    /**
     * @var \Opit\OpitHrm\CurrencyRateBundle\Service\MNBExchangeRateService
     */
    private $exch;
    ...
    {
        $mockExch = $this->getMockBuilder('Opit\OpitHrm\CurrencyRateBundle\Service\MNBExchangeRateService')
    ...
    public function testFetchCurrentExchangeRates()
    {
        ...
        $stubExch = $this->getMockBuilder('Opit\OpitHrm\CurrencyRateBundle\Service\MNBExchangeRateService')
