...
use Opit\OpitHrm\UserBundle\Form\DataTransformer\SimpleIntegerToStringTransformer;
...
class EmployeeType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options)
    {
        ...
        $leaveConfig = $this->container->getParameter('opit_opit_hrm_leave');
        ...
        $builder->add('teams', 'entity', array(
            'label' => 'Teams',
            'class' => 'OpitOpitHrmUserBundle:Team',
            'property' => 'teamName',
            'required' => false,
            'multiple' => true,
            'expanded' => true,
        ...
        if ($this->container->get('security.context')->isGranted('ROLE_SYSTEM_ADMIN')) {
            $builder->add('jobTitle', 'entity', array(
                'class' => 'OpitOpitHrmUserBundle:JobTitle',
                'property' => 'title',
                'multiple' => false,
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Opit\OpitHrm\UserBundle\Entity\Employee',
