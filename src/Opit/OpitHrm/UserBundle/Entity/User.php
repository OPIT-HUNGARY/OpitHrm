 ...
 *
 * @ORM\Table(name="opithrm_users")
 * @ORM\Entity(repositoryClass="Opit\OpitHrm\UserBundle\Entity\UserRepository")
...
class User implements UserInterface, \Serializable, TravelRequestUserInterface, NotificationUserInterface
{
     ...
     * @ORM\JoinTable(name="opithrm_users_groups")
     */
    protected $groups;

    /**
     * User travel requests
     * @ORM\OneToMany(targetEntity="\Opit\OpitHrm\TravelBundle\Entity\TravelRequest", mappedBy="user", cascade={"remove"})
     */
    protected $userTravelRequests;

    /**
     * General manager travel requests
     * @ORM\OneToMany(targetEntity="\Opit\OpitHrm\TravelBundle\Entity\TravelRequest", mappedBy="generalManager", cascade={"remove"})
     */
    protected $gmTravelRequests;

    /**
     * Team manager travel requests
     * @ORM\OneToMany(targetEntity="\Opit\OpitHrm\TravelBundle\Entity\TravelRequest", mappedBy="teamManager", cascade={"remove"})
     */
    protected $tmTravelRequests;

    /**
     * General manager leave requests
     * @ORM\OneToMany(targetEntity="\Opit\OpitHrm\LeaveBundle\Entity\LeaveRequest", mappedBy="generalManager", cascade={"remove"})
     */
    protected $gmLeaveRequests;

    /**
     * Team manager leave requests
     * @ORM\OneToMany(targetEntity="\Opit\OpitHrm\LeaveBundle\Entity\LeaveRequest", mappedBy="teamManager", cascade={"remove"})
     */
    protected $tmLeaveRequests;

    /**
     * Hiring manager job positions
     * @ORM\OneToMany(targetEntity="\Opit\OpitHrm\HiringBundle\Entity\JobPosition", mappedBy="hiringManager", cascade={"remove"})
     */
    protected $hmJobPositions;

    /**
     * Notifications sent by user
     * @ORM\OneToMany(targetEntity="\Opit\OpitHrm\NotificationBundle\Entity\Notification", mappedBy="receiver", cascade={"remove"})
     */
    protected $notifications;

    /**
     * User travel expenses
     * @ORM\OneToMany(targetEntity="\Opit\OpitHrm\TravelBundle\Entity\TravelExpense", mappedBy="user", cascade={"remove"})
     */
     ...
     * Add groups
     *
     * @param  \Opit\OpitHrm\UserBundle\Entity\Groups $groups
     * @return User
     */
    public function addGroup(\Opit\OpitHrm\UserBundle\Entity\Groups $groups)
    {
        $this->groups[] = $groups;
     ...
     * @param \Opit\OpitHrm\UserBundle\Entity\Groups $groups
     */
    public function removeGroup(\Opit\OpitHrm\UserBundle\Entity\Groups $groups)
    {
