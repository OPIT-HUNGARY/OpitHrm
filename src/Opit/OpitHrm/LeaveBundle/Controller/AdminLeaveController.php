...
use Opit\OpitHrm\LeaveBundle\Form\LeaveCategoryType;
use Opit\OpitHrm\LeaveBundle\Entity\LeaveDate;
use Opit\OpitHrm\LeaveBundle\Form\LeaveDateType;
use Opit\OpitHrm\LeaveBundle\Entity\LeaveType;
use Opit\OpitHrm\LeaveBundle\Form\LeaveTypeType;
use Opit\OpitHrm\LeaveBundle\Entity\LeaveSetting;
use Opit\OpitHrm\LeaveBundle\Form\LeaveSettingType;
...
class AdminLeaveController extends Controller
{
     ...
     *
     * @Route("/secured/admin/list/leave/categories", name="OpitOpitHrmLeaveBundle_admin_list_leave_categories")
    ...
    public function listLeaveCategoriesAction()
    {
        ...
        if ($request->request->get('issearch')) {
            ...
            $leaveCategories = $em->getRepository('OpitOpitHrmLeaveBundle:LeaveCategory')->findBy(
                array(),
        ...
        foreach ($leaveCategories as $leaveCategory) {
            $leaves = $em->getRepository('OpitOpitHrmLeaveBundle:Leave')->findBy(
        ...
        return $this->render(
            'OpitOpitHrmLeaveBundle:Admin:' . ($showList ? '_' : '') . 'listLeaveCategories.html.twig',
            array(
     ...
     *
     * @Route("/secured/admin/add/leave/category/{id}", name="OpitOpitHrmLeaveBundle_admin_add_leave_category", requirements={ "id" = "\d+"})
     * @Secure(roles="ROLE_SYSTEM_ADMIN")
     * @Method({"POST"})
     * @Template()
     */
     ...
     *
     * @Route("/secured/admin/show/leave/category/{id}", name="OpitOpitHrmLeaveBundle_admin_show_leave_category", requirements={"id" = "\d+"})
     * @Secure(roles="ROLE_SYSTEM_ADMIN")
     * @Method({"GET"})
     * @Template()
     */
    public function showLeaveCategoryFormAction()
    {
        ...
        return $this->render(
            'OpitOpitHrmLeaveBundle:Admin:showLeaveCategoryForm.html.twig',
            array('form' => $form->createView())
        );
    }

    /**
     * To delete leave categories in OPIT-HRM
     *
     * @Route("/secured/admin/delete/leave/category", name="OpitOpitHrmLeaveBundle_admin_delete_leave_category")
     * @Secure(roles="ROLE_SYSTEM_ADMIN")
     * @Method({"POST"})
     */
    public function deleteLeaveCategoryAction()
    {
        ...
        foreach ($ids as $id) {
            $leaves = $em->getRepository('OpitOpitHrmLeaveBundle:Leave')->findBy(array('category' => $id));
     ...
     *
     * @Route("/secured/admin/list/leave/dates", name="OpitOpitHrmLeaveBundle_admin_list_leave_dates")
     * @Secure(roles="ROLE_SYSTEM_ADMIN")
     * @Method({"GET", "POST"})
     * @Template()
     */
    public function listLeaveDateAction()
    {
        ...
        $years = $em->getRepository('OpitOpitHrmLeaveBundle:LeaveDate')->findAllYears();
        $types = $em->getRepository('OpitOpitHrmLeaveBundle:LeaveType')->findAll();
        $leaveDates = array();
        ...
        if ($showList || $isSearch) {
            ...
            $leaveDates = $em->getRepository('OpitOpitHrmLeaveBundle:LeaveDate')->findAllFiltered($searchProperties);
        } else {
        ...
        return $this->render(
            'OpitOpitHrmLeaveBundle:Admin:' . ($showList || $isSearch ? '_' : '') . 'listLeaveDates.html.twig',
    ...
    public function showLeaveDateFormAction()
    {
        ...
        return $this->render(
            'OpitOpitHrmLeaveBundle:Admin:showLeaveDateForm.html.twig',
            array('form' => $form->createView())
        );
    }
    ...
    /**
     * To delete Administrative Leave/Working Day in OPIT-HRM
     *
     * @Route("/secured/admin/delete/leave/date", name="OpitOpitHrmLeaveBundle_admin_delete_leave_date")
     * @Secure(roles="ROLE_SYSTEM_ADMIN")
     * @Method({"POST"})
     */
     ...
     *
     * @Route("/secured/admin/list/leave/types", name="OpitOpitHrmLeaveBundle_admin_list_leave_types")
     * @Secure(roles="ROLE_SYSTEM_ADMIN")
     * @Method({"GET", "POST"})
     * @Template()
     */
    public function listLeaveTypeAction()
    {
        ...
        $orderParams = $request->request->get('order');
        $em = $this->getDoctrine()->getManager();
        $leaveTypes = $em->getRepository('OpitOpitHrmLeaveBundle:LeaveType')->findAll();
        $numberOfRelations = array();

        if ($request->request->get('issearch')) {
            // Find by order parameters.
            $leaveTypes = $em->getRepository('OpitOpitHrmLeaveBundle:LeaveType')->findBy(
                array(),
                array($orderParams['field'] => $orderParams['dir'])
            );
        } else {
        ...
        foreach ($leaveTypes as $leaveType) {
            $leaveDates = $em->getRepository('OpitOpitHrmLeaveBundle:LeaveDate')->findBy(
                array(
        ...
        return $this->render(
            'OpitOpitHrmLeaveBundle:Admin:' . ($showList ? '_' : '') . 'listLeaveTypes.html.twig',
            array(
     ...
     *
     * @Route("/secured/admin/show/leave/type/{id}", name="OpitOpitHrmLeaveBundle_admin_show_leave_type", requirements={"id" = "\d+"})
     * @Secure(roles="ROLE_SYSTEM_ADMIN")
     * @Method({"GET"})
     * @Template()
     */
    public function showLeaveTypeFormAction()
    {
        ...
        return $this->render(
            'OpitOpitHrmLeaveBundle:Admin:showLeaveTypeForm.html.twig',
            array('form' => $form->createView())
        );
    }
     ...
     *
     * @Route("/secured/admin/add/leave/type/{id}", name="OpitOpitHrmLeaveBundle_admin_add_leave_type", requirements={ "id" = "\d+"})
     * @Secure(roles="ROLE_SYSTEM_ADMIN")
     * @Method({"POST"})
     * @Template()
     */
    ...
    /**
     * To delete Administrative Leave/Working Day types in OPIT-HRM
     *
     * @Route("/secured/admin/delete/leave/type", name="OpitOpitHrmLeaveBundle_admin_delete_leave_type")
     * @Secure(roles="ROLE_SYSTEM_ADMIN")
     * @Method({"POST"})
     */
    public function deleteLeaveTypeAction()
    {
        ...
        foreach ($ids as $id) {
            $leaveDates = $em->getRepository('OpitOpitHrmLeaveBundle:LeaveDate')->findBy(array('holidayType' => $id));
     ...
     *
     * @Route("/secured/admin/list/leave/options", name="OpitOpitHrmLeaveBundle_admin_list_leave_settings")
     * @Secure(roles="ROLE_SYSTEM_ADMIN")
     * @Method({"GET", "POST"})
     * @Template()
     */
    public function listLeaveSettingsAction()
    {
        ...
        if ($isEnabled) {
            $em = $this->getDoctrine()->getManager();
            $leaveSettings = $em->getRepository('OpitOpitHrmLeaveBundle:LeaveSetting')->findAll();
            $leaveGroups = $em->getRepository('OpitOpitHrmLeaveBundle:LeaveGroup')->findAll();
        ...
        return $this->render(
            $showList ? 'OpitOpitHrmLeaveBundle:Admin:_listLeaveSettings.html.twig' : 'OpitOpitHrmLeaveBundle:Admin:listLeaveSettings.html.twig',
     ...
     *
     * @Route("/secured/admin/show/leave/option/{id}", name="OpitOpitHrmLeaveBundle_admin_show_leave_setting", defaults={"id" = "new"}, requirements={ "id" = "\d|new"})
     * @Secure(roles="ROLE_SYSTEM_ADMIN")
     * @Method({"GET"})
     * @Template()
     */
    public function showLeaveSettingAction(Request $request)
    {
        ...
        return $this->render(
            'OpitOpitHrmLeaveBundle:Admin:showLeaveSettingForm.html.twig',
    ...
    protected function setLeaveSettingData($leaveSetting, $data)
    {
        ...
        $leaveGroup = $em->getRepository('OpitOpitHrmLeaveBundle:LeaveGroup')->find((integer)$data['leaveGroup']);
    ...
    protected function getLeaveSetting($leaveSettingId = null, $throwError = true)
    {
        ...
        $leaveSetting = $em->getRepository('OpitOpitHrmLeaveBundle:LeaveSetting')->find($leaveSettingId);
    ...
    protected function getLeaveCategory($leaveCategoryId = null)
    {
        ...
        $leaveCategory = $em->getRepository('OpitOpitHrmLeaveBundle:LeaveCategory')->find($leaveCategoryId);
    ...
    protected function getLeaveType($leaveTypeId = null)
    {
        ...
        $leaveType = $em->getRepository('OpitOpitHrmLeaveBundle:LeaveType')->find($leaveTypeId);
    ...
    protected function getLeaveDate($leaveDateId = null)
    {
        ...
        $leaveDate = $em->getRepository('OpitOpitHrmLeaveBundle:LeaveDate')->find($leaveDateId);
