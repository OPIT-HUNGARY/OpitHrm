...
use Opit\OpitHrm\LeaveBundle\Form\LeaveType;
use Opit\OpitHrm\LeaveBundle\Form\DataTransformer\EmployeeIdToObjectTransformer;
   ...
   /**
    ...
    public function setDefaultOptions(OptionsResolverInterface $resolver)
    {
        $resolver->setDefaults(array(
            'data_class' => 'Opit\OpitHrm\LeaveBundle\Entity\LeaveRequest'
        ))
        ->setRequired(array(
            'em',
        ))
