...
namespace Opit\OpitHrm\HiringBundle\EventListener;
...
class JobPositionPostListener
{
    ...
    public function postLoad(LifecycleEventArgs $args)
    {
        ...
        if ($entity instanceof JobPosition) {
            $link = $this->router->generate("OpitOpitHrmHiringBundle_job_application", array('token' => $entity->getExternalToken()), UrlGeneratorInterface::ABSOLUTE_URL);
