...
class Version20140619145049 extends AbstractMigration
{
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("ALTER TABLE notes_job_position_applicants DROP FOREIGN KEY FK_6C3D0CA697139001");
        $this->addSql("DROP TABLE notes_applicants");
