...
class Version20131213153254 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql("CREATE TABLE IF NOT EXISTS opithrm_job_titles (id INT AUTO_INCREMENT NOT NULL, title VARCHAR(100) NOT NULL, description VARCHAR(255) NOT NULL, PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8 COLLATE utf8_unicode_ci ENGINE = InnoDB");
        ...
        $this->addSql("DROP TABLE IF EXISTS opithrm_jobs");
        if ($schema->hasTable('opithrm_users') && !$schema->getTable('opithrm_users')->hasColumn('job_title_id')) {
            $this->addSql("ALTER TABLE opithrm_users CHANGE job_id job_title_id INT DEFAULT NULL");
            $this->addSql("UPDATE opithrm_users SET job_title_id = NULL;");
            
            if (!$schema->getTable('opithrm_users')->hasForeignKey('FK_8E744D496DD822C6')) {
            ...
            if (!$schema->getTable('opithrm_users')->hasIndex('UNIQ_8E744D496DD822C6')) {
                $this->addSql("CREATE UNIQUE INDEX UNIQ_8E744D496DD822C6 ON opithrm_users (job_title_id)");
            }
        }
    }
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql("DROP TABLE opithrm_job_titles");
        $this->addSql("DROP TABLE acl_classes");
        $this->addSql("DROP TABLE acl_security_identities");
        $this->addSql("DROP TABLE acl_object_identities");
        $this->addSql("DROP TABLE acl_object_identity_ancestors");
        $this->addSql("DROP TABLE acl_entries");
        $this->addSql("DROP INDEX UNIQ_8E744D496DD822C6 ON opithrm_users");
        $this->addSql("ALTER TABLE opithrm_users CHANGE job_title_id job_id INT DEFAULT NULL");
    }
}
